<div id="errorAlert" style="display: {{ $errors->any() ? 'flex' : 'none' }}" class="flex-row p-4 mt-4 mr-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400" role="alert">
